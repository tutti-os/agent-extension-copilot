...
class ACPProcess:
    ...
    def drain_notifications(self, duration: float) -> None:
...
def main() -> int:
    ...
    parser.add_argument(
        ...
        type=float,
        default=0.25,
        help="bounded wait for notifications emitted just after session/new",
    )
    ...
    try:
        ...
        if not args.initialize_only:
            ...
            runtime.drain_notifications(args.notification_wait)
